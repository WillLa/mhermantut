...
declare enum queryResultErrorCode {
    noData = 0,
    notEmpty = 1,
    multiple = 2
}
...
// API: http://vitaly-t.github.io/pg-promise/module-pg-promise.html
declare function pgPromise(options?: IOptions<IEmptyExt>): pgPromise.IMain;
declare function pgPromise<Ext>(options?: IOptions<Ext>): pgPromise.IMain;
